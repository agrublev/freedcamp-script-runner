...
import { loadPlugins, registerPluginCommands, findExternalPluginDirs } from "./lib/plugins/loader.js";
        ...
        handler: async () => {
            ...
            const allPlugins = [
                ...
                ...pluginCmds
                    ...
                    .map((c) => ({ name: c.name, description: c.description || "", source: "builtin" })),
            ];

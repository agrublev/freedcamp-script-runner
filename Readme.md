- [⚡ fsr](#%E2%9A%A1-fsr)
  ...
  * [🚀 get started in 3 commands](#%F0%9F%9A%80-get-started-in-3-commands)
  * [🤔 what is fscripts.md?](#%F0%9F%A4%94-what-is-fscriptsmd)
  * [build:prod](#buildprod)
  * [🤯 full javascript blocks — yes, really](#%F0%9F%A4%AF-full-javascript-blocks--yes-really)
  * [🎮 commands](#%F0%9F%8E%AE-commands)
  * [⚡ parallel & sequential execution](#%E2%9A%A1-parallel--sequential-execution)
  * [🔐 encryption](#%F0%9F%94%90-encryption)
  * [🔌 plugins](#%F0%9F%94%8C-plugins)
    + [built-in plugins](#built-in-plugins)
    + [project-local plugins](#project-local-plugins)
  ...
  * [🩺 doctor](#%F0%9F%A9%BA-doctor)
  * [😤 why not just use package.json?](#%F0%9F%98%A4-why-not-just-use-packagejson)
  * [📝 the fscripts.md format](#%F0%9F%93%9D-the-fscriptsmd-format)
  * [another-script](#another-script)
  * [🌍 environment profiles](#%F0%9F%8C%8D-environment-profiles)
    + [syntax](#syntax)
    + [using `--env`](#using---env)
  ...
  * [push](#push-1)
  * [🆚 fsr vs. the alternatives](#%F0%9F%86%9A-fsr-vs-the-alternatives)
  * [💡 pro tips](#%F0%9F%92%A1-pro-tips)
...
| 📂 `fsr toc-file`    | pick any `.md` file (interactive picker) and generate its TOC        |
...
Got other markdown docs? Pick any file with the interactive file picker:

```bash
fsr toc-file
```

Only `.md` files are accepted — pick anything else and the picker re-opens until you choose a markdown file (or cancel). 📂

Both commands are also available straight from the bare `fsr` interactive picker.

    ...
    return arr.map(e => {
        ...
        if (boldMatches !== null) {
            boldMatches.forEach(m => {
                e = e.replace(m, chalk.bold.redBright.bgHex("#000d13")(m.replace(/\*\*/g, " "))); //.underline.bgBlack.whiteBright
            });
        }
        ...
        if (underlineMatches !== null) {
            underlineMatches.forEach(m => {
                e = e.replace(m, chalk.underline.greenBright.bgHex("#000d13")(m.replace(/\_\_/g, " "))); //.underline.bgBlack.whiteBright
            });
        }
        return e;
    });

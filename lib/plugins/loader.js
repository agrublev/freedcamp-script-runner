...
const resolvePluginsDir = () => {
    ...
    const candidates = [
        // Source tree: this file lives in lib/plugins → use that dir
        join(selfDir),
        // Packed install: plugins copied to dist/plugins → check sibling "plugins" dir
        join(selfDir, "plugins"),
        // In-repo execution from project root
        resolve(process.cwd(), "lib", "plugins")
    ];

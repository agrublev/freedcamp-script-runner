...
var cr = require('../utils/encryption.js');
var ref2 = require('../utils/index.js'), ref3 = ref2 ? ref2 : _throw(new TypeError("Cannot destructure 'undefined' or 'null'")), boxInform = ref3.boxInform;
var ConfigCommand = function(_Command) {
    _inherits(ConfigCommand, _Command);
    function ConfigCommand() {
        _classCallCheck(this, ConfigCommand);
        return _possibleConstructorReturn(this, _getPrototypeOf(ConfigCommand).apply(this, arguments));
    }
    _createClass(ConfigCommand, [{
            key: 'run',
            value: function run() {
                return _asyncToGenerator((function*() {
                    var ref4 = this.parse(ConfigCommand), ref5 = ref4 ? ref4 : _throw(new TypeError("Cannot destructure 'undefined' or 'null'")), flags1 = ref5.flags1;
                    var direction = flags1.direction || false;
                    // prettier-ignore
var isEncrypting = direction && direction === 'encrypt';
                    boxInform(isEncrypting ? 'Encrypting files with key' : 'Decrypting files', '-----');
                    yield cr.init(isEncrypting);
                }).bind(this))();
            }
        }]);
...
ConfigCommand.flags = {
    direction: flags.string({
        'char': 'd',
        description: 'direction {encrypt|decrypt}'
    })
};
